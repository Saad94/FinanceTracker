...
ALIASES = {
  ...
  'Pakistan Air'                : ['Pakistan International Airlines', CATEGORIES['AIRLINES'],       ''              ],
  ...
  'TURKISH AIRLINES'            : ['Turkish Airlines',                CATEGORIES['AIRLINES'],       ''              ],
  ...
  'CASHBACK BONUS REDEMPTION'   : ['Credit Card Cashback',            CATEGORIES['INCOME'],         ''              ],
  ...
  'GOURDOUGH'                   : ['Gourdough\'s',                    CATEGORIES['RESTAURANTS'],    ''              ],
